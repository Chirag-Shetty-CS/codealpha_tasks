...
● Displays a random quote every time the user opens the app or clicks a button. /n
● Includes a "New Quote" button that shows a different quote on each click. /n
